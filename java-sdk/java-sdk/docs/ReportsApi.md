...
# **getPushReport**
> PushReport getPushReport(campaignHash, operatingSystems, brands)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean brands = true; // Boolean | True to show brand stats
    try {
      PushReport result = apiInstance.getPushReport(campaignHash, operatingSystems, brands);
