...
public class ReportsApi {
     ...
     * @param brands True to show brand stats (optional, default to true)
     ...
     */
    public okhttp3.Call getPushReportCall(String campaignHash, Boolean operatingSystems, Boolean brands, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getPushReportValidateBeforeCall(String campaignHash, Boolean operatingSystems, Boolean brands, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getPushReportCall(campaignHash, operatingSystems, brands, _callback);
        return localVarCall;
     ...
     */
    public PushReport getPushReport(String campaignHash, Boolean operatingSystems, Boolean brands) throws ApiException {
        ApiResponse<PushReport> localVarResp = getPushReportWithHttpInfo(campaignHash, operatingSystems, brands);
     ...
     */
    public ApiResponse<PushReport> getPushReportWithHttpInfo(String campaignHash, Boolean operatingSystems, Boolean brands) throws ApiException {
        okhttp3.Call localVarCall = getPushReportValidateBeforeCall(campaignHash, operatingSystems, brands, null);
     ...
     */
    public okhttp3.Call getPushReportAsync(String campaignHash, Boolean operatingSystems, Boolean brands, final ApiCallback<PushReport> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPushReportValidateBeforeCall(campaignHash, operatingSystems, brands, _callback);
        Type localVarReturnType = new TypeToken<PushReport>(){}.getType();
