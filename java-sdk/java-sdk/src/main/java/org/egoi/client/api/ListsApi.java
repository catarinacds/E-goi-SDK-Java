...
public class ListsApi {
     ...
     */
    public List createList(PostRequestList postRequestList) throws ApiException {
        ApiResponse<List> localVarResp = createListWithHttpInfo(postRequestList);
     ...
     */
    public ApiResponse<List> createListWithHttpInfo(PostRequestList postRequestList) throws ApiException {
     ...
     */
    public okhttp3.Call createListAsync(PostRequestList postRequestList, final ApiCallback<List> _callback) throws ApiException {
    ...
    private okhttp3.Call getListValidateBeforeCall(Integer listId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getListCall(listId, _callback);
        return localVarCall;
     ...
     */
    public List updateList(Integer listId, PatchRequestList patchRequestList) throws ApiException {
        ApiResponse<List> localVarResp = updateListWithHttpInfo(listId, patchRequestList);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List> updateListWithHttpInfo(Integer listId, PatchRequestList patchRequestList) throws ApiException {
     ...
     */
    public okhttp3.Call updateListAsync(Integer listId, PatchRequestList patchRequestList, final ApiCallback<List> _callback) throws ApiException {
