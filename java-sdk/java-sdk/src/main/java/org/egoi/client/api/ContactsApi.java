...
import org.egoi.client.model.ImportBulkResponse;
...
public class ContactsApi {
     ...
     */
    public ImportBulkResponse actionImportBulk(Integer listId, ImportBulkRequest importBulkRequest) throws ApiException {
        ApiResponse<ImportBulkResponse> localVarResp = actionImportBulkWithHttpInfo(listId, importBulkRequest);
        return localVarResp.getData();
    }
     ...
     * @param listId ID of the List (required)
     * @param importBulkRequest Parameters for the bulk import (required)
     * @return ApiResponse&lt;ImportBulkResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ImportBulkResponse> actionImportBulkWithHttpInfo(Integer listId, ImportBulkRequest importBulkRequest) throws ApiException {
        okhttp3.Call localVarCall = actionImportBulkValidateBeforeCall(listId, importBulkRequest, null);
        Type localVarReturnType = new TypeToken<ImportBulkResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call actionImportBulkAsync(Integer listId, ImportBulkRequest importBulkRequest, final ApiCallback<ImportBulkResponse> _callback) throws ApiException {
